<%-- 
    ...
    Created on : Feb 25, 2024, 12:42:03 PM
    Author     : acer
--%>
...
<html>
    <head>
        ...
        <title>C?p nh?t voucher|CoffeeLand</title>
    </head>
    <style>
            .input-box header{
                font-size: x-large;
            ...
            <div class="container mainn">
                <div class="col-md-3 left">
                    <form action="/CoffeeLand/updateimg" method="post" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="target" value="UpdateVoucher">
                ...
                <div class="col-md-6 right">
                    <div class="input-box" style="width: 700px;
                        ...
                        <header style="font-size: x-large;
                                ...
                                text-align: center;
                                margin-bottom: 13px;
                                color: red;">Cập nhật Khuyến mãi</header>
                        <div style="text-align: right; color: greenyellow;">
                            <i>Người chỉnh sửa lần cuối: <%=x.getUser()%></i>
                        </div>
                        <form action="/CoffeeLand/updatevoucher" method="get" enctype="multipart/form-data">
                            <table class="table">
                                <td class="col-md-2">
                                    <div class="">
                                        <div class="text-info">Tên voucher *<div>
                                                <textarea type="text" class="input" name="voucherName" required><%=x.getVoucherName()%></textarea>
                                    </div>
                                    <div class="">
                                        <div class="text-info">Mã voucher *<div>
                            ...
                            <div class="">
                                ...
                                <div class="input-field">
                                    <input type="submit" class="submit" value="Cập nhật khuyến mãi">
                                </div> 
                            </div>      
                        </form>
                    </div>
