...
<%
    ...
    List<Category> lstCategory = (List<Category>) cDAO.getListCategory(-1);
...
<html>
    <head>
        ...
        <title>Thêm san pham|CoffeeLand</title>
    </head>
    <style>
            .input-box header{
                font-size: x-large;
            ...
            <div class="container mainn">
                ...
                <div class="col-md-3 left">
                    <form action="/CoffeeLand/updateimg" method="post" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="target" value="AddProduct">
                ...
                <div class="col-md-6 right">
                    <div class="input-box" style="width: 700px;
                        ...
                        <header style="font-size: x-large;
                                ...
                                text-align: center;
                                margin-bottom: 13px;
                                color: red;">Thêm sản phẩm</header>
                                <form action="/CoffeeLand/addproduct" method="post" enctype="multipart/form-data">
                            <table class="table">
                                <td class="col-md-2">
                                    ...
                                    <div class="input">
                                        <select id="categorySelect" class="input" style="width: 200px" name="categoryId" required>
                            ...
                            <div class="">
                                <input type="hidden" class="" name="statusId" value="1">
                            ...
                            <div class="">
                                <div class="input-field">
                                    <input type="submit" class="submit" name="requestAction" value="Thêm sản phẩm">
                                </div> 
                            </div>      
                        </form>
                    </div>
