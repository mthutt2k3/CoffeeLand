<%-- 
    ...
    Created on : Mar 7, 2024, 11:03:01 PM
    Author     : dell
--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/CoffeeLand/assests/css/CSSMaketer/updateslider.css">
                ...
                <div class="row bg-bodylist" style="height: fit-content">
                    ...
                    <div class="before">
                        ...
                        <table border="1">
                            ...
                            <tr>
                                <td><img style="width:100px;" src="/CoffeeLand/assests/image/background/${sessionScope.image}" alt="alt"/></td>
                                <td>${sessionScope.order}</td>
                                <td>${sessionScope.link}</td>
                            </tr>
                        </table>
                    </div>
                    <div class="after">
                        <p>Thông tin sửa slide</p>
                        <div class="update">
                            <form action="/CoffeeLand/updatesliderinfo" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="sliderID" value="${sessionScope.sliderId}"/>
                                <p>Tải ảnh mới slide lên: <input type="file" name="file" required/></p>
                            ...
                            <select name="orderS">
                                ...
                                <p>Liên kết mới của slide (link): <input type="text" name="link" required/></p>
