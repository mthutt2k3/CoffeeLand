                ...
                <div class="row" style="height: 1500px; width: 1200px">
                    ...
                    <div class="col-md-6 right">
                        <div class="input-box">
                            ...
                            <form action="/CoffeeLand/orderdetail" method="GET">
                                ...
                                if(lstDetailPro != null){
                                    for(ProductSaler a: lstDetailPro) {
                                        ...
                                        <div class="product-item">
                                            <img src="/CoffeeLand/assests/image/thumbnails/<%= a.getThumbnail() %>" alt="<%= a.getProductName() %>" class="product-thumbnail" style="width: 80px; height: 80px;">
                                ...
                                <div class="input-field">
                                    <input type="submit" class="submit" name="requestAction" value="Cập nhật trạng thái">
                                </div>
                            </form>
                        </div>  
                    </div>
