                ...
                <div class="row bg-bodylist" style="height: fit-content">
                        ...
                        <div class="card text-white shadow" style="background-color: rgb(99, 159, 184)">
                            <div class="card-body d-flex justify-content-center align-items-center">
                                <div class="text-center">
                                    ...
                                    <h3 class="mb-0"><%=lstProduct.size()%></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card text-white shadow" style="background-color: rgb(99, 159, 184)">
                            <div class="card-body d-flex justify-content-center align-items-center">
                                <div class="text-center">
                                    <p class="mb-0">Số lượng đơn hàng</p>
                                    <h3 class="mb-0"><%=lstOrder.size()%></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card text-white shadow" style="background-color: rgb(99, 159, 184)">
                            <div class="card-body d-flex justify-content-center align-items-center">
                                <div class="text-center">
                                    <p class="mb-0">Số lượng người dùng</p>
                                    <h3 class="mb-0"><%=lstU%></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card text-white shadow" style="background-color: rgb(99, 159, 184)">
                            <div class="card-body d-flex justify-content-center align-items-center">
                                <div class="text-center">
                                    <p class="mb-0">Số lượng tin tức</p>
                                    <h3 class="mb-0"><%=lstN%></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card text-white shadow" style="background-color: rgb(99, 159, 184)">
                            <div class="card-body d-flex justify-content-center align-items-center">
                                <div class="text-center">
                                    ...
                                    <h3 class="mb-0"><%=lstC%></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <form action="/CoffeeLand/datastatistics" method="POST">
                        <div class="text-info">
