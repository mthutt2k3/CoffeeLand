...
<html>
    <head>
        ...
        <title>Tạo người dùng mới|CoffeeLand</title>
    </head>
    <body>
        <!--nav-->
        ...
        <div class="wrapper">
            <div class="container main">
                <div class="row" style="height: 800px; width: 1200px">
                    <div class="col-md-6 side-image" style="background-image: url(/CoffeeLand/assests/image/background/adduser2.jpg)">
                    </div>
                        ...
                        <div class="input-box">
                           ...
                           <form action="/CoffeeLand/control" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <label class="text-light text-opacity-75">
                                        <input type="radio" name="role" value="2" required> Marketer
                                    </label>
                                    <label class="text-light text-opacity-75">
                                        <input type="radio" name="role" value="3" required> Saler
                                    </label>
                                    <label class="text-light text-opacity-75">
                                        <input type="radio" name="role" value="5" required> Saler Manager
                                    </label>
                                </div>
                                <div class="input-field">
                                    <input type="submit" class="submit" name="requestAction" value="Tạo người dùng">
                                </div> 
                           </form>
                        </div>  
                    </div>
