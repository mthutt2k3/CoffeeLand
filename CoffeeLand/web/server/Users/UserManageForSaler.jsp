z<%-- 
    Document   : UserManageForSaler
    Created on : Jan 27, 2024, 7:43:28 PM
    Author     : Admin
--%>
...
<%
    List<Users> lst = (List<Users>) session.getAttribute("lstCus");
    String colName;
%>
<!DOCTYPE html>
<html>
    <head>
        <title>Quản lý khách hàng|CoffeeLand</title>
        <meta charset="UTF-8">
                ...
                <div class="row bg-bodylist" style="height: fit-content">
                    ...
                    <div class="mb-3 mt-2">
                        <form class="search-form mx-auto" action="/CoffeeLand/control" method="GET">
                            <input type="hidden" name="target" value="UserManageForSaler"/>
                            <input type="hidden" name="requestAction" value="Search"/>
                            <input type="search" name="input" class="search-inputlist form-control" placeholder="Tìm kiếm khách hàng...">
                            <button type="submit" class="search-button"></button>
                        </form>
                        <form action="/CoffeeLand/server/Users/CreateCustomer.jsp">
                            <button type="submit" 
                            ...
                            <tr>
                                ...
                                <td class="form-control" style="display: flex">
                                    ...
                                    <form action="/CoffeeLand/control" method="POST">
                                        ...
                                        <button type="submit" class="btn btn-outline-success mx-1 border-0 p-0" title="Cập nhật khách hàng">
                            ...
                            <ul class="pagination">
                                <c:forEach begin="1" end="${totalPages}" varStatus="page">
                                    <li class="page-item ${page.index == currentPage ? 'active' : ''}">
                                        <a class="page-link" href="/CoffeeLand/usermanageforsaler?page=${page.index}">${page.index}</a>
                                    </li>
                                </c:forEach>
                            </ul>
                        </div>
