            ...
            <div class="container">
                ...
                <div class="row" >
                     ...
                     <c:forEach var="o" items="${list}" varStatus="loop">
                        <div class="col-lg-4 d-flex align-items-stretch ftco-animate" onclick="redirectToNewsDetail('${o.newsId}')">
                            <div class="news-item-container">
                                <div class="text p-4 bg-light">  

                                    <div class="click">
                                        <img src="/CoffeeLand/assests/image/thumbnails/${o.image}" class="img-fluid">
                                        <h4 class="heading mb-3">${o.title}</h4>
                                    </div>
                                    <div class="meta">
                                        <p><span class="fa fa-calendar"></span> ${o.postedTime}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col text-center">
                    <div class="block-27">
                        <c:forEach begin="1" end="${end}" var="i">
                            <a href="searchnews?index=${i}&txtSearch=${txtSearch}">${i}</a>
                        </c:forEach>
                    </div>
                </div>
            </div>
