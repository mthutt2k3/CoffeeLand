    ...
    <body>
        ...
        <div class="container-fluid py-5">
            <div class="row">
                ...
                <div class="col-md-4">
                    <form id="searchForm" action="/CoffeeLand/searchordeforcus" method="GET">
            ...
            <div class="container py-5">
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <%int stt= 0;
                                for(Orders x : lstOrder){ stt++;%>
                            <tr>
                                <td>
                                    <p class="mb-0 mt-4"><%=stt%></p>
                                </td>
                                <td>
                                    <p class="mb-0 mt-4"><%= x.getOrderCode() %></p>
                                </td>
                                <td>
                                    <p class="mb-0 mt-4"><%= x.getReceiverName() %></p>
                                </td>
                                <td>
                                    <p class="mb-0 mt-4 price"><%= x.getOrderTime() %></p>
                                </td>
                                <td>
                                    <p class="mb-0 mt-4 price"><%= x.getGrandTotal() %></p>
                                </td>
                                <%if(x.getStatusId().equals("1")){%>
                                <td>
                                    <p class="mb-0 mt-4 price"> Chờ xác nhận </p>
                                </td>
                                <%}%>
                                <%if(x.getStatusId().equals("2")){%>
                                <td>
                                    <p class="mb-0 mt-4 price"> Đang chuẩn bị </p>
                                </td>
                                <%}%>
                                <%if(x.getStatusId().equals("3")){%>
                                <td>
                                    <p class="mb-0 mt-4 price"> Đang giao hàng </p>
                                </td>
                                <%}%>
                                <%if(x.getStatusId().equals("4")){%>
                                <td>
                                    <p class="mb-0 mt-4 price"> Giao hàng thành công </p>
                                </td>
                                <%}%>
                                <%if(x.getStatusId().equals("5")){%>
                                <td>
                                    <p class="mb-0 mt-4 price"> Giao hàng không thành công </p>
                                </td>
                                <%}%>
                                <td>
                                    <form action="/CoffeeLand/orderdetailforcus" method="GET" style="display: inline;">
                                        <input type="hidden" name="orderId" value="<%=x.getOrderId()%>" />
                                        <button type="submit" class="btn btn-md rounded-3 bg-light border mt-4 ml-2">
                                            <i class="fa fa-eye text-primary"></i>
                                            <span>Xem</span>
                                        </button>
                                    </form>
                                    <form action="/CoffeeLand/orderhistoryforcus" method="POST" style="display: inline;">
                                        <%if(x.getStatusId().equals("1")){%>
                                        <input type="hidden" name="orderId" value="<%=x.getOrderId()%>"/>
                                        <button type="submit" class="btn btn-md rounded-3 bg-light border mt-4">
