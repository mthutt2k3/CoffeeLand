...
<%@include file="/navigator/ToastClient.jsp" %>
    ...
    <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">Cập nhật đơn hàng</h1>
            <ol class="breadcrumb justify-content-center mb-0">
                ...
                <li class="breadcrumb-item"><a href="/client/order/OrderDetailForCus.jsp">Chi tiết đơn hàng</a></li>
                <li class="breadcrumb-item active text-white">Cập nhật đơn hàng</li>
            </ol>
        </div>
    ...
    <div class="card">
        <form name="yourForm" action="/CoffeeLand/updateorderforcus" method="POST" onsubmit="return validateForm()">
        ...
        <div class="info">
            ...
            <div class="row">
                <div class="col-6">
                    <span id="heading">Tên người nhận<sup>*</sup></span>
                </div>
                <div class="col-6 text-right">

                    <input type="text" class="input" name="receiverName" value="<%=x.getReceiverName()%>" required>
                </div>
            </div>
            <div class="row">
                <div class="col-6">
                    <span id="heading">Địa chỉ nhận hàng<sup>*</sup></span>
                </div>
                <div class="col-6 text-right">
                    <input type="text" class="input" name="receiverAddress" value="<%=x.getReceiverAddress()%>" required>
                </div>
            </div>
            
            <div class="row">
                <div class="col-6">
                    <span id="heading">Số điện thoại<sup>*</sup></span>
                </div>
                <div class="col-6 text-right">
                    <input type="tel" class="input" name="receiverPhone" value="<%=x.getReceiverPhone()%>" required>
                </div>
            </div>
        ...
        <%if(x.getStatusId().equals("Chờ xác nhận")){%>
            ...
            <button  class="btn border-secondary rounded-pill px-4 py-3 text-primary text-uppercase mb-4 ms-4 checkoutButton" type="submit">Cập nhật</button>
...
function validateForm() {
    var phoneNumber = document.forms["yourForm"]["receiverPhone"].value;
    var phoneRegex = /^[0-9]{10}$/; // Regex cho số điện thoại (10 chữ số)
