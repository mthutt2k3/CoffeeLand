...
.dropdown:hover .dropdown-menu {
    ...
    <body>
                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="/CoffeeLand/listvoucherclient" class="nav-item nav-link active">Khuyến mãi</a>
        ...
        <div class="container">
            <div class="row" >
                <div class="col-xs-12"> <!-- Modified class to center the section -->
                    ...
                    <c:forEach items="${lst}" var="s">
                        ...
                        <section class="search-result-item">
                            ...
                            <a class="image-link" href="#"><img class="image" style="width: 180px; height: 180px" src="/CoffeeLand/assests/image/thumbnails/${s.getVoucherImage()}"></a>
                            <div class="search-result-item-body">
                                <div class="row">
                                    <div class="col-sm-9">
                                        <h3 class="search-result-item-heading" style="margin-bottom: 10px; font-weight: 500;"><a href="#">Tên Voucher: ${s.getVoucherName()}</a></h3>
                                        <h4 class="search-result-item-heading"><a href="#">Mã Voucher: ${s.getVoucherCode()}</a></h4>
                                        <p class="info">Start Date: ${s.getStartDate()}</p>
                                        <p class="info">End Date: ${s.getExpirationDate()}</p>
                                        <p class="description">${s.getDescription()}</p>
                                    </div>
                                    <div class="col-sm-3 text-align-center">
                                        <p class="value3 mt-sm">${s.getDiscount()} %</p>
                                        <p class="fs-mini text-muted">Đơn hàng tối thiểu: ${s.getCondition()}VND</p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row mt-5">
                <div class="col text-center">
                    ...
                    <c:forEach begin="1" end="${endP}" var="i">
                        <a href="listvoucherclient?index=${i}">${i}</a>
                    </c:forEach>
                </div>
            </div>
        </div>
