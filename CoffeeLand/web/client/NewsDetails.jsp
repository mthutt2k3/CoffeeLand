    ...
    <body>
        ...
        <section class="ftco-section">
                        ...
                        <div class="col-md-8 offset-md-2">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-text"><small class="text-muted">Ngày Đăng: ${details.postedTime}</small></p>
                                    <img src="/CoffeeLand/assests/image/thumbnails/${details.image}" class="img-fluid" style="width: 822px; height: 463px;" onclick="redirectToNewsDetail('${news.newsId}')">
            ...
            <div class="container mt-5">
                <h3 class="text-center">CÁC TIN KHÁC</h3> 
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col" class="black-text"><h5>Tiêu đề</h5></th>
                            <th scope="col" class="black-text"><h5>Ngày Đăng</h5></th>
                        </tr>
                    </thead>
                    <tbody>
                        <c:forEach items="${lstNewsDt}" var="i">
                            <tr onclick="redirectToNewsDetail('${i.newsId}')">
                                <td class="title">${i.title}</td>
                                <td class="title"><i class="far fa-calendar-alt"></i>${i.postedTime}</td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
