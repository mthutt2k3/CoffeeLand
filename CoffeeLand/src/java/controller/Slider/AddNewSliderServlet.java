 ...
 */
@MultipartConfig
public class AddNewSliderServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        request.getRequestDispatcher("/CoffeeLand/server/slider/AddNewSlider.jsp").forward(request, response);
    }
