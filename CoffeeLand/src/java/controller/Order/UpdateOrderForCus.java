 ...
 * @author Admin
 */
public class UpdateOrderForCus extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UpdateOrderForCus</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet UpdateOrderForCus at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        response.sendRedirect("/CoffeeLand/client/order/UpdateOrderForCus.jsp");
    } 
    ...
    throws ServletException, IOException {
        ...
        u.UpdateOrderForCus(id, receiverName, receiverAddress, receiverPhone);
        session.setAttribute("alert", "Cập nhật đơn hàng thành công");
        response.sendRedirect("/CoffeeLand/orderhistoryforcus");
    }
