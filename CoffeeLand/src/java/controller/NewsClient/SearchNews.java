...
public class SearchNews extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            int count = newsdao.count(txtSearch);
            int pageSize = 3;
            int endPage = 0;
            ...
            List<News> listSearch = newsdao.search(txtSearch, index, pageSize);
            request.setAttribute("end", endPage);
            request.setAttribute("list", listSearch);
            request.setAttribute("txtSearch", txtSearch);
            
            
            request.getRequestDispatcher("client/SearchResultPage.jsp").forward(request, response);
        } catch (Exception e) {
        }
    } 
